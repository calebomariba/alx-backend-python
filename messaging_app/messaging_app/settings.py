...
SECRET_KEY = "django-insecure-=a9^v+2@l6_%(!32@ynqj+^xli+&8+f7fyl1#qd@z)z7=6)yat"
...
DATABASES = {
    'default': dj_database_url.config(
        default='mysql://root:password@127.0.0.1:3306/test_db'
    )
}
...
#         'rest_framework.permissions.IsAuthenticated',  # If required
#     ],
# }
